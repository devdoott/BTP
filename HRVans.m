...
for j=1:22
    ...
    hentropy=[hentropy;[7+j EAF(k)+0.5]];
    k=k+1;
    %hold on
end
k=1;
...
grid on
    ...
    ylabel('Entropy','FontSize',14,'FontWeight','bold','Color','b')
    title('Entropy vs patient no.','FontSize',16)
